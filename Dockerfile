...
echo y | android update sdk -a -u -t platform-tools,${ANDROID_APIS},${ANDROID_BUILD_TOOLS},e-android-support,extra-android-m2repository,extra-google-m2repository,extra-google-google_play_services && \
rm ${ANDROID_SDK_FILE} 
